...
export default function SelectField({ label, accessibilityLabel = label, compact = false, value, options, onChange }: { label: string; accessibilityLabel?: string; compact?: boolean; value: string; options: { value: string; label: string }[]; onChange: (value: string) => void }) {
