...
export default function App() {
  ...
  async function exportPdf() {
    ...
    if (exportMode === "持ち出し用") {
      ...
      const html = `<!doctype html><html><head><meta charset="utf-8"><style>@page{size:A4 portrait;margin:12mm 10mm}*{box-sizing:border-box}body{font-family:-apple-system,BlinkMacSystemFont,'Helvetica Neue',sans-serif;color:#111;margin:0}h1{font-size:9px;margin:0 0 5mm;color:#111}.sheet{width:100%;display:flex;flex-direction:column;align-items:center;gap:20mm}.ticket{position:relative;width:110mm;height:91mm;display:grid;grid-template-columns:55mm 55mm;border:1.2px solid #163763;overflow:hidden;break-inside:avoid;page-break-inside:avoid;background:#fff}.ticketLabel{position:absolute;right:1.8mm;top:1.5mm;font-size:5px;font-weight:900;color:#163763}.foldLine{position:absolute;top:0;bottom:0;left:55mm;border-left:1px dashed #6c86aa;z-index:5}.foldLine span{position:absolute;top:1mm;left:-5mm;font-size:4px;color:#6c86aa;background:#fff}.cutLine{position:absolute;left:0;right:0;bottom:-6mm;border-bottom:1px dashed #6c86aa;text-align:center;color:#6c86aa;font-size:4px}.cutLine span{position:relative;top:2.4mm;background:#fff;padding:0 2mm}.face{position:relative;width:55mm;height:91mm;padding:3.1mm 2.4mm 3.4mm;overflow:hidden}.face h2{font-size:8.2px;line-height:1;margin:0;color:#173863;font-weight:900;letter-spacing:.3px}.sub{font-size:4.8px;line-height:1;margin:.8mm 0 2mm;color:#173863;font-weight:900}.face i{position:absolute;right:2.2mm;top:2.8mm;font-style:normal;font-size:4px;font-weight:900;color:#173863}.summary{background:#f0eee9;padding:1.6mm 1.8mm;margin:0 0 2.2mm;min-height:10mm}.summary b{display:block;font-size:5.2px;line-height:1.2;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.summary span{display:block;font-size:4.7px;line-height:1.22;font-weight:800}table{width:100%;border-collapse:collapse;table-layout:fixed;font-size:5.3px}th,td{border:1px solid #173863;padding:.58mm .45mm;text-align:left;vertical-align:middle;line-height:1.06;font-weight:850;overflow:hidden}th{background:#edf4f1;color:#173863;font-size:4.9px}.raceDay th:nth-child(1),.raceDay td:nth-child(1){width:9mm}.raceDay th:nth-child(2),.raceDay td:nth-child(2){width:15mm}.raceDay th:nth-child(3),.raceDay td:nth-child(3){width:auto}.raceDay td:nth-child(1){font-size:6.4px}.raceDay td strong{display:block;font-size:7px;line-height:1;font-weight:950}.raceDay td small{display:block;font-size:4.1px;color:#4b5c57;line-height:1.05;margin-top:.4mm}.compare th:first-child,.compare td:first-child{width:8mm}.compare th{font-size:4.6px;text-align:center}.compare th strong{font-size:4.4px}.compare td{font-size:5px;text-align:center;padding:.45mm .25mm}.compare td:first-child{text-align:left;font-size:5.8px}.compare td b{display:block;font-size:6.2px;line-height:1;font-weight:950}.compare td span{display:block;font-size:3.9px;color:#4b5c57;line-height:1;margin-top:.4mm}.foot{position:absolute;left:2.4mm;right:2.4mm;bottom:1.8mm;margin:0;font-size:3.6px;line-height:1.15;color:#555}.spare{margin-top:0}@media print{body{margin:0}tr{break-inside:avoid}.ticket{break-inside:avoid;page-break-inside:avoid}}</style></head><body><h1>RUN Finish Planner / レース本番用 縦型名刺二つ折り v20260705-vertical</h1><div class="sheet">${ticket("本番用")}${ticket("控え")}</div></body></html>`;
      if (Platform.OS === "web") {
        const web = globalThis as any;
